    ...
    return (
        <React.Fragment>
            ...
            <div>
                ...
                <div className="">
                    <section className="grid grid-cols-6 gap-4 my-4 h-full overflow-y-auto">
                        ...
                        <div className="col-span-4 bg-white rounded p-6">3</div>
                        <div className="col-span-2 bg-white rounded p-6">
                            <h3 className="text-primary-950 font-black uppercase text-sm">
                                Recent News
                            </h3>
                                ...
                                >
                                    ...
                                    <div className="overflow-hidden ml-1 p-2">
                                        <h5 className="text-primary-950 text-sm font-black uppercase line-clamp-2 leading-5">
                                            Geologists Utilize Artificial Intelligence to Enhance
